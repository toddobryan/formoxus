//! The bridge between a widget and the value store.
//!
//! `pub` because a custom widget has to read and write like any built-in one,
...
/// exactly what the built-in widgets use — without it, every custom widget
